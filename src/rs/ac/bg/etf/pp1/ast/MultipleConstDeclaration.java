...
public class MultipleConstDeclaration extends MultipleConstDecl {

    private MultipleConstDecl MultipleConstDecl;
    private SingleConstDecl SingleConstDecl;

    public MultipleConstDeclaration (MultipleConstDecl MultipleConstDecl, SingleConstDecl SingleConstDecl) {
